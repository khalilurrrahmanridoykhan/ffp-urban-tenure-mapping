    ...
    for c in classified:
        ...
        if c["action"] == "reject_not_a_parcel":
            submissions.append({
                ...
                "claimant_name": None, "household_size": None, "tenure_type": None,
        ...
        for _, hh in claimants.iterrows():
            ...
            sub = {
                ...
                "claimant_name": hh.occupant_name, "household_size": int(hh.household_size), "tenure_type": tenure,
    ...
    for t_idx in missed:
        ...
        for _, hh in claimants.iterrows():
            ...
            submissions.append({
                ...
                "claimant_name": hh.occupant_name, "household_size": int(hh.household_size), "tenure_type": draw_tenure(),
                "dispute_flag": "yes" if is_disputed else "no",
                "dispute_notes": rng.choice(DISPUTE_NOTES) if is_disputed else None,
